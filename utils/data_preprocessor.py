...
# Required Arguments
parser.add_argument('--root-dir', type=str, default="./BraTS19/Training_Original")
parser.add_argument('--proc-dir', type=str, default="./BraTS19/Training_Processed")
...
for disease_type in [constants.HGG, constants.LGG]:
    for subj in listdir(join(args.root_dir, disease_type)):
        subj_dir = join(args.root_dir, disease_type, subj)
        item = (subj_dir, subj, disease_type)
        q.put(item)
